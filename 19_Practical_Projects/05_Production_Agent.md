...
**Cost per conversation:** Total tokens (input + output) × price per token. Typical support conversation: 2K-10K tokens. At GPT-5.4 pricing ($2.50/M input, $15/M output): $0.005-0.07 per conversation.

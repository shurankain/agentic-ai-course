...
**NVIDIA Vera Rubin — now in full production** (Computex, June 1, 2026). The next-generation platform after Blackwell. 50 PFLOPS FP4, 288 GB HBM4, 22 TB/s memory bandwidth, 10x performance-per-watt vs Grace Blackwell. NVLink 6 at 3.6 TB/s (2x Blackwell). TSMC 3nm process. Supply chain nearly 2x the size of the Grace Blackwell ramp based on what Jensen Huang called "outsized" AI demand. Assembly: 5 minutes per rack. Fall 2026 shipments to hyperscalers. Expected to generate $1T+ in orders through 2027. Major hyperscalers are already deploying ~1,000 NVL72 racks per week each (72,000 Blackwell GPUs per week per hyperscaler). NVIDIA Q1 FY27: $81.6B revenue (+85% YoY).

**NVIDIA RTX Spark** (Computex 2026) — the first ARM-based AI PC superchip. Grace CPU (20-core ARM, co-designed with MediaTek) + Blackwell RTX GPU (6,144 CUDA cores, fifth-gen Tensor Cores with FP4) connected via NVLink-C2C. Up to 128 GB unified LPDDR5X memory (300 GB/s bandwidth), 1 PFLOP of AI performance. Runs 120B+ parameter models locally. Ships fall 2026 in laptops and desktops from ASUS, Dell, HP, Lenovo, Microsoft Surface, and MSI. A three-generation roadmap: Spark (Blackwell, 2026), Vera Rubin Spark (2028), Rosa Feynman Spark (2030). This positions NVIDIA to compete directly in the consumer PC market — not just data centers.
...
**Huawei Ascend ramp-up (as of late June 2026):** China's primary GPU alternative to NVIDIA. Ascend 910C production target: ~600,000 units (2x 2025 volume). Ascend 950PR expected Q1 2026, 950DT in Q4 2026. **Atlas 950 SuperPoD** (8,192 chips) targeted for Q4 2026. NVIDIA/SK hynix signed a multiyear memory co-development partnership (June 17) spanning Vera Rubin, RTX Spark, and Jetson Thor — deepening the NVIDIA supply chain advantage that Huawei cannot match. The Ascend ecosystem remains constrained by the ROCm-like software gap: fewer optimized libraries, limited framework support, and smaller developer community compared to CUDA. However, for Chinese AI labs operating under US export controls, Ascend is the only viable option at scale.

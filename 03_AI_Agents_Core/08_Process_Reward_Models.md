...
**Synthetic labeling** is automatic annotation using a strong model. GPT-5.4 or Claude evaluate solution steps. This is cheaper but introduces the teacher model's bias.

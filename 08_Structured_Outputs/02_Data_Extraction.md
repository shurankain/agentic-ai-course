...
Extraction is no longer limited to text. Vision-language models (GPT-5.4, Claude Sonnet 4.6, Gemini 3.5 Flash) can extract structured data directly from images, PDFs, and scanned documents.

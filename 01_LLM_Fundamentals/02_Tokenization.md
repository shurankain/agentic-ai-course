...
**Cost calculation** accounts for both input and output tokens, since providers price them differently. For example, GPT-4o input tokens cost $2.50 per 1M, output $10 per 1M. For Claude Sonnet 4.6 — $3 and $15 per 1M respectively. Newer models like GPT-5 and Claude Opus 4.6 are priced higher; economy models like GPT-4o-mini ($0.15/$0.60 per 1M) and Claude Haiku 4.5 ($0.25/$1.25 per 1M) are dramatically cheaper. Multiplying token counts by prices and summing yields a realistic cost estimate.

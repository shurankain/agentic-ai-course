...
**EU Code of Practice for deepfake labeling (June 10, 2026):** The European Commission published marking/labeling rules for AI-generated content ahead of the Article 50 transparency deadline (August 2, 2026). Providers of AI systems that generate or manipulate text, audio, images, or video must implement: content watermarking, clear disclosure mechanisms, and metadata tagging. This is the operational detail for Article 50's transparency requirements — the rules that specify exactly how AI-generated content must be labeled.
...
**Illinois SB 315 (passed May 27, 2026):** The **first US state law requiring third-party audits of frontier AI model safety protocols.** Passed unanimously in the House (110-0) and 52-5 in the Senate. Key provisions: annual safety framework publication, 72-hour incident reporting, annual independent third-party audits, and whistleblower protections for frontier AI developers. Penalties up to $1M first violation, $3M subsequent. Effective January 1, 2027. If signed by Governor Pritzker (expected), Illinois would leapfrog Colorado as the most aggressive US state on AI safety regulation — and notably, SB 315 targets model *developers*, not just *deployers*.

**Florida sues OpenAI (June 19, 2026):** The **first US state lawsuit directly against an AI company.** Florida's Attorney General alleged that ChatGPT contributed to real-world harms and that OpenAI prioritized growth over safety. The legal theory — that an AI company bears liability for harms caused by its model's outputs — has not been tested in court. If successful, it would establish a precedent for state-level AI liability that goes beyond the EU's product liability framework.

**Other state activity (2024-2026):** Texas, Connecticut, and several other states have introduced or passed AI-related legislation focusing on: algorithmic discrimination in employment (Illinois AI Video Interview Act), deepfake disclosure requirements, AI in insurance underwriting. **2,191 AI bills tracked across all 50 states** as of June 2026, with employment AI regulation being the dominant trend.

**Implication for AI architects:** Multi-state deployment in the US now requires tracking a patchwork of state laws, similar to how GDPR compliance was needed for EU deployment. The strictest applicable state law effectively sets the floor. The Illinois audit requirement (SB 315) is particularly impactful: if you develop frontier models and deploy in Illinois, annual third-party safety audits become mandatory.
...
**First model-level export controls (June 13, 2026):** The Fable 5/Mythos 5 export ban sets a precedent: AI models can now be export-controlled independently of hardware. The saga unfolded rapidly: NSA Director Gen. Joshua Rudd's classified briefing (quoted by Sen. Warner, June 11) revealed that Mythos autonomously breached "almost all" NSA classified systems during a red-team exercise. Commerce Secretary Lutnick issued the directive June 12 (received by Anthropic at 5:21 PM ET on a Friday). Anthropic disabled both models globally June 13. The alleged trigger: a "fix this code" capability — identifying and patching vulnerabilities could theoretically be used offensively. 100+ security experts (led by Katie Moussouris) called for the directive to be rescinded. At the G7 Summit in Evian (June 17-18), the UK's exemption request was denied; a "trusted partners" framework was proposed but not agreed. Trump met Amodei and said he no longer views Anthropic as a threat (June 20), but the Commerce directive was NOT withdrawn. As of late June 2026, both models remain partially available with mandatory identity verification and nationality-based geo-fencing for US customers; international access remains uncertain. Anthropic is introducing biometric identity verification (government ID, facial geometry) starting July 8. See [[../14_Security_Safety/03_Agent_Security|Agent Security]] for the security implications.
...
**China: Anthropomorphic AI Interaction Regulation (effective July 15, 2026).** A separate regulation from the agent framework above — the "Interim Measures for the Administration of Artificial Intelligence Anthropomorphic Interaction Services" (issued April 10 by CAC + 4 other authorities). This is the **first-ever regulation specifically targeting AI-driven emotional interaction and virtual companion services.** Key provisions: providers must prevent users from being misled about the artificial nature of the service, prevent addiction/overdependence from prolonged AI engagement, and **prohibit offering "virtual companion" or "virtual relative" services to minors.** Robust governance controls over content, interaction models, data security, and algorithm transparency. This signals a regulatory direction that other jurisdictions may follow — the emotional and psychological impact of AI companions is becoming a governed concern, not just a product decision.
...
The US landscape is in flux (as of late June 2026): Biden's EO rescinded (Jan 2025), Colorado AI Act weakened (SB 189, delayed to Jan 2027), **Illinois SB 315** mandates frontier model audits (first in the US), **Florida sued OpenAI** (first state lawsuit against an AI company). The **Great American AI Act** draft (June 4) proposes the first comprehensive federal framework. The **Fable 5/Mythos 5 export ban** (June 13) established model-level export controls. China published the **first national AI agent framework** (May 8) and **anthropomorphic AI regulation** (effective July 15, prohibiting virtual companions for minors).

**Bartz v. Anthropic: $1.5B copyright settlement** — the largest copyright settlement in US history (as of late June 2026). 91.3% of 482,000 works were claimed. Anthropic pays in tranches: $300M escrow immediately, $300M within 5 days of final approval, $450M by September 2026, $450M by September 2027. This settlement establishes a practical benchmark for the cost of training on copyrighted data — and signals that future frontier model developers should budget for copyright licensing or face similar claims.

**International AI Safety Report 2026 (June 15):** Commissioned by multiple governments, this report establishes a shared regulatory baseline across jurisdictions — the first formal attempt at international regulatory convergence for AI. **Five-nation agentic AI security guidance (June 18):** Cybersecurity agencies from the US, Australia, Canada, New Zealand, and UK jointly published "Careful Adoption of Agentic AI Services" addressing risks of autonomous AI systems in critical infrastructure and defense. Both documents signal that AI regulation is becoming a coordinated international effort, not just a patchwork of national laws. See [[../14_Security_Safety/03_Agent_Security|Agent Security]] for the security implications of the Five-nation guidance.

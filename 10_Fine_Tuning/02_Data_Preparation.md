...
**Synthetic generation** uses a strong model (GPT-5.4) to create examples. Advantage: scalability and speed. Limitation: risk of inheriting issues from the generating model.
